...
print
'DN----search', p.search_userDN(username)
print
'DN-ty', type(p.search_userDN(username))
print
'user--valid', p.valid_user(ldap_authuser, ldap_authpass)  # 调用valid_user()方法验证用户是否为合法用户